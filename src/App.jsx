...
const styles = {
  ...
  appContent:     { flex: 1, minHeight: 0, display: "flex", flexDirection: "column", touchAction: "pan-y" },
  tabVisible:     { flex: 1, display: "flex", flexDirection: "column", minHeight: 0, touchAction: "pan-y" },
  tabHidden:      { display: "none" },
  trainerContent: { flex: 1, minHeight: 0, overflowY: "auto", WebkitOverflowScrolling: "touch", touchAction: "pan-y", display: "flex", flexDirection: "column", paddingBottom: "calc(60px + var(--safe-bottom, 0px))" },
